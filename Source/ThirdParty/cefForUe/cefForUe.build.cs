...
public class cefForUe : ModuleRules
{
    ...
    void MakeStartScript(string libcef_path)
    {
        ...
        string Architecture = "Linux";// = Target.Architecture.ToString();
        if (Target.Architecture == UnrealArch.Arm64) {
            Architecture = "LinuxAArch64";
        }
        string run_script = "";
        run_script += "#!/bin/sh \n";
        run_script += "export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:" + libcef_path + " \n";
